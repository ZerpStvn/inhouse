      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-8 py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-slate-500">New Session</span>
          </div>
          <h1 className="text-2xl font-semibold text-slate-900">Create Exam Session</h1>
          <p className="text-slate-500 mt-1">Set up a new secure exam session for your students</p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Optional description that students will see before starting"
                />
              </div>
            </div>
          </div>
